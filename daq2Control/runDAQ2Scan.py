...
def getListOfSizes(maxSize, minSize=256, short=False, stepSize=256):
	...
	if short:
		allsteps = [256, 512, 1024, 2048, 3072, 4096, 5120, 6144, 8192, 12288, 16384]
	else:
		allsteps = [256, 512, 768, 1024, 1280, 1536, 1792, 2048, 2304, 2560, 2816,
		            3072, 3328, 3584, 3840, 4096, 5120, 6144, 7168, 8192, 10240,
		            12288, 14336, 16384]
