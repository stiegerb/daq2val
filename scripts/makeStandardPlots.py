...
def makeStandardPlots(rootfile, outDir):
	...
	list_8s8fx1x2   = [ prefix % 'Aug13' + x for x in ['8s8fx1x2_ptfrl', '8s8fx1x2_RMS_0.5', '8s8fx1x2_RMS_1', '8s8fx1x2_RMS_2']]
	list_16s8fx1x2  = [ prefix % 'Aug13' + x for x in ['16s8fx1x2_RMS_0', '16s8fx1x2_RMS_0.5', '16s8fx1x2_RMS_1', '16s8fx1x2_RMS_2']]
	list_16s16fx2x2 = [ prefix % 'Aug13' + x for x in ['16s16fx2x2_RMS_0', '16s16fx2x2_RMS_0.5', '16s16fx2x2_RMS_1', '16s16fx2x2_RMS_2']]
	list_32s16fx4x4 = [ prefix % 'Aug13' + x for x in ['32s16fx4x4_c6220_RMS_0', '32s16fx4x4_c6220_RMS_0.5', '32s16fx4x4_c6220_RMS_1', '32s16fx4x4_c6220_RMS_2']]
	...
	list_16s16fx2x2 = [ prefix % 'Aug15' + x for x in ['16s16fx2x2', '16s16fx2x2_RMS_0.5', '16s16fx2x2_RMS_1', '16s16fx2x2_RMS_2']]
	...
	outputdir = createDir(outDir+'FEROLs/gevb2g/Sep4/')
	list_24s12fx1x2  = [prefix % 'Sep4' + '24s12fx2x2_RMS_0.0']
	list_24s12fx1x2 += [prefix % 'Sep4' + '24s12fx2x2_RMS_0.5']
	list_24s12fx1x2 += [prefix % 'Sep4' + '24s12fx2x2_RMS_1.0']
	list_24s12fx1x2 += [prefix % 'Sep4' + '24s12fx2x2_RMS_2.0']
	makeMultiPlot(rootfile, list_24s12fx1x2, oname=outputdir+'24s12fx2x2', tag='FEROL:gevb2g', legends=map(lambda x:'24s12fx2x2, ' + x, legends))

	list_24s12fx1x2  = [prefix % 'Sep4' + '8s8fx1x2_RMS_0.0']
	list_24s12fx1x2 += [prefix % 'Sep4' + '8s8fx1x2_RMS_0.5']
	list_24s12fx1x2 += [prefix % 'Sep4' + '8s8fx1x2_RMS_1.0']
	list_24s12fx1x2 += [prefix % 'Sep4' + '8s8fx1x2_RMS_2.0']
	makeMultiPlot(rootfile, list_24s12fx1x2, oname=outputdir+'8s8fx2x2', tag='FEROL:gevb2g', legends=map(lambda x:'8s8fx1x2, ' + x, legends))
